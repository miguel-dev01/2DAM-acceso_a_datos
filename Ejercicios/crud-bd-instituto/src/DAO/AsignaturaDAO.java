...
public class AsignaturaDAO {
	...
	public List<Asignatura> consultasPersonalizadas(String query) {
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
		...
		try {
			...
			while (rs.next()) {
                ...
                asignatura.setCodInterno(rs.getString("cod_interno"));
                asignatura.setDescripcion(rs.getString("descripcion"));
                asignatura.setNHoras(rs.getInt("nHoras"));
                asignatura.setCodCurso(rs.getString("cod_curso"));
